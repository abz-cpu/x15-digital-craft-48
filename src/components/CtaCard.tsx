...
const CtaCard: React.FC = () => {
  return (
    <section className="relative py-16 md:py-20 overflow-hidden bg-[#D9F7F4]">
      {/* Enhanced, premium radial glows */}
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_25%_40%,hsl(var(--primary)/0.10),transparent_60%)]" />
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_75%_60%,hsl(var(--accent)/0.08),transparent_60%)]" />
      ...
      <Container size="narrow" className="relative">
        ...
        {/* Main Card */}
        <div className="mx-auto max-w-2xl rounded-3xl bg-card/95 backdrop-blur-md border border-border shadow-xl shadow-primary/5 overflow-hidden transition-all duration-500">
          <div className="px-6 sm:px-8 py-8 space-y-5">
            ...
            <div className="text-center space-y-2 pt-1">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border bg-background/80 px-4 py-2
                  text-sm font-medium text-primary hover:border-[#25D366] hover:text-[#25D366]
                  transition-all"
              >
