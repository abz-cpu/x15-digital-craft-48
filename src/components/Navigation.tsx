      ...
      >
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 h-full">
          ...
          <div className="flex items-center h-full">
            ...
            >
              {/* L&D Monogram Icon - Premium elegant design */}
              <svg
              ...
              >
                {/* Elegant geometric container - rounded square */}
                <rect x="10" y="10" width="80" height="80" rx="16" fill="hsl(var(--primary))" opacity="0.1" />
                <rect x="10" y="10" width="80" height="80" rx="16" stroke="hsl(var(--primary))" strokeWidth="3" />

                {/* L - Bold, geometric, premium */}
                <path
                  d="M28 32 L28 68 L50 68"
                ...
                {/* D - Sophisticated rounded form */}
                <path
                  d="M56 32 L56 68 M56 32 L66 32 C72 32 72 38 72 50 C72 62 72 68 66 68 L56 68"
                  stroke="hsl(var(--primary))"
                  strokeWidth="6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
