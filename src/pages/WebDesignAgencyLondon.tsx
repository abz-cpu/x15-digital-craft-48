        ...
        <section className="py-16">
          <Container>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                { name: "Stratford", link: "/areas/stratford" }, { name: "Ilford", link: "/areas/ilford" },
                { name: "Hackney", link: "/areas/hackney" }, { name: "Shoreditch", link: "/areas/shoreditch" },
                { name: "Leyton", link: "/areas/leyton" }, { name: "Newham", link: "/areas/newham" }
              ].map((area, index) => (
                <Link key={index} to={area.link} className="px-4 py-2 bg-card border rounded-full hover:border-primary transition-colors">{area.name}</Link>
              ))}
            </div>
          </Container>
        </section>
        ...
        <section className="py-16 bg-primary text-primary-foreground">
          <Container>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <Button asChild size="lg" variant="secondary"><Link to="/contact">Get Your Free Quote <ArrowRight className="ml-2 h-5 w-5" /></Link></Button>
            </div>
          </Container>
        </section>
      </main>
...
export default WebDesignAgencyLondon;
              <div className="max-w-4xl mx-auto text-center">
                <span className="inline-block px-4 py-2 rounded-full bg-primary/10 text-primary font-medium text-sm mb-6">
                  London's Trusted Web Design Agency
                </span>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                  Web Design Agency London: Professional Websites from £200
                </h1>
                <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                  We're Luminous & Deliver Digital, a London-based web design agency creating stunning, 
                  high-converting websites for businesses across the UK. Fast delivery. Transparent pricing. 
                  Real results.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Unlike traditional agencies charging £5,000+, we deliver professional websites at accessible prices 
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <AnimatedSection key={index} animation="fade-up" delay={index * 100}>
                  <div className="bg-card p-6 rounded-xl border hover:border-primary/50 transition-colors h-full">
                    <feature.icon className="h-10 w-10 text-primary mb-4" />
                    <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
                    <p className="text-muted-foreground">{feature.description}</p>
                  </div>
        ...
        <section className="py-16">
          <Container>
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Web Design Services We Offer in London
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  From simple brochure sites to complex ecommerce platforms, we create websites that drive business growth.
                </p>
              </div>
            </AnimatedSection>
              ...
              {[
                {
                  ...
                  description: "Professional brochure sites that establish credibility and convert visitors into customers.",
                  features: ["Mobile-responsive design", "Contact forms & CTAs", "SEO optimisation", "Fast loading speeds"],
                  link: "/services/landing-pages"
                },
                {
                  title: "Ecommerce Websites",
                  description: "Online stores built to sell. Shopify, WooCommerce, or custom solutions.",
                  features: ["Secure payment gateways", "Product management", "Inventory tracking", "Order automation"],
                  link: "/services/ecommerce"
                },
                {
                  title: "WordPress Development",
                  description: "Custom WordPress sites with easy content management and powerful functionality.",
                  features: ["Easy content editing", "Plugin integration", "Custom themes", "Regular updates"],
                  link: "/platforms/wordpress"
                },
                {
                  title: "Restaurant Websites",
                  description: "Mouth-watering designs with online menus, booking systems, and delivery integration.",
                  features: ["Online menus", "Table reservations", "Delivery integration", "Local SEO"],
                  link: "/web-package"
                },
                {
                  title: "Landing Pages",
                  description: "High-converting landing pages designed to capture leads and drive action.",
                  features: ["A/B testing ready", "Form integration", "Fast loading", "Conversion focused"],
                  link: "/services/landing-pages"
                },
                {
                  title: "Website Redesign",
                  description: "Transform outdated websites into modern, mobile-friendly experiences.",
                  features: ["Modern aesthetics", "Improved UX", "Better performance", "SEO preservation"],
                  link: "/contact"
                }
              ].map((service, index) => (
                <AnimatedSection key={index} animation="fade-up" delay={index * 100}>
                  <div className="bg-card p-6 rounded-xl border hover:shadow-lg transition-all h-full flex flex-col">
          ...
          <Container>
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  A streamlined process that delivers exceptional results without the agency overhead.
                </p>
              </div>
            </AnimatedSection>
          ...
          <Container>
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Based in Stratford, East London, we work with clients throughout the capital and across the UK.
                </p>
              </div>
            </AnimatedSection>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <Link
                  key={index}
                  to={area.link}
                  className="px-4 py-2 bg-card border rounded-full hover:border-primary hover:bg-primary/5 transition-colors"
                >
                  {area.name}
                </Link>
              ))}
          ...
          <Container>
            <AnimatedSection animation="fade-up">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Common questions about web design services in London.
                </p>
              </div>
            </AnimatedSection>
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl opacity-90 mb-8">
                Get a free, no-obligation quote for your new website. We'll respond within 24 hours.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
