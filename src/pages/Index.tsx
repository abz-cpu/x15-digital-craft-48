...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section aria-label="Platforms and tools we work with" className="bg-white border-y border-slate-100 py-8">
        ...
        <div style={{ overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', width: 'max-content', animation: 'marquee-scroll 40s linear infinite' }}
            ...
            {[
              /* Google */
              <span key="google" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300 flex-shrink-0">
              ...
              /* Ahrefs */
              <span key="ahrefs" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300 flex-shrink-0">
                <svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#FF642D">
                ...
                <span className="text-sm font-semibold text-slate-700">Ahrefs</span>
              </span>,
              /* Shopify */
              ...
              /* SEMrush */
              <span key="semrush" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300">
                ...
                <span className="text-sm font-semibold text-slate-700">SEMrush</span>
              </span>,
              /* Stripe */
              ...
              /* Yell.com */
              <span key="yell" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300">
                <svg viewBox="0 0 48 20" className="h-5 w-auto flex-shrink-0" aria-hidden="true">
                ...
                <span className="text-sm font-semibold text-slate-700">Yell.com</span>
              </span>,
              /* Elementor */
              <span key="elementor" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300">
                <svg viewBox="0 0 40 40" className="h-7 w-7 flex-shrink-0" aria-hidden="true">
                ...
                <span className="text-sm font-semibold text-slate-700">Elementor</span>
              </span>,
              /* Square */
              ...
              /* Google Cloud */
              <span key="gcloud" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300">
                <svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true">
                ...
                <span className="text-sm font-semibold text-slate-700">Google Cloud</span>
              </span>,
            ].flatMap((logo, i) => [logo, <span key={`sep-a-${i}`} className="text-slate-200 text-xl mx-10 flex-shrink-0" aria-hidden="true">·</span>])}
            {/* ---- Logo set B (duplicate for seamless loop) ---- */}
            {[
              <span key="google-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg><span className="text-sm font-semibold text-slate-700">Google</span></span>,
              <span key="ahrefs-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#FF642D"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm.45 14.5h-2.1l-1.1-3H7.5l-1.05 3H4.4L8.3 7.5h2.85l3.3 9zm4.8 0h-1.95V7.5h1.95v9z"/><path d="M9.2 12.2l-1-2.85-1 2.85h2z"/></svg><span className="text-sm font-semibold text-slate-700">Ahrefs</span></span>,
              <span key="shopify-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#96BF48"><path d="M15.337 23.979l7.216-1.561s-2.604-17.613-2.625-17.73c-.018-.116-.114-.192-.211-.192s-1.902-.134-1.902-.134-.943-.942-1.055-1.037c-.018-.02-.037-.038-.076-.057l-.943 19.711zM11.088 8.162s-.423-.114-1.057-.114c-1.69 0-2.511 1.056-2.511 2.072 0 1.132.862 1.69 1.649 2.188 1.035.634 1.4.942 1.4 1.593 0 .65-.576 1.114-1.34 1.114-.961 0-1.496-.327-1.496-.327l-.269 1.613s.596.308 1.573.308c1.842 0 3.049-1.075 3.049-2.457 0-1.191-.865-1.746-1.63-2.225-.748-.479-1.418-.882-1.418-1.573 0-.479.362-1.056 1.383-1.056.537 0 .962.154.962.154l.705-1.29z"/></svg><span className="text-sm font-semibold text-slate-700">Shopify</span></span>,
              <span key="react-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#61DAFB"><path d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278z"/></svg><span className="text-sm font-semibold text-slate-700">React</span></span>,
              <span key="semrush-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 40 40" className="h-7 w-7 flex-shrink-0" aria-hidden="true"><rect width="40" height="40" rx="8" fill="#FA4B0E"/><text x="20" y="27" textAnchor="middle" fontFamily="Arial Black, Arial, sans-serif" fontWeight="900" fontSize="18" fill="#fff">S</text></svg><span className="text-sm font-semibold text-slate-700">SEMrush</span></span>,
              <span key="stripe-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#635BFF"><path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.591-7.305z"/></svg><span className="text-sm font-semibold text-slate-700">Stripe</span></span>,
              <span key="cloudflare-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#F48120"><path d="M16.608 15.175l.109-.375c.264-.9.165-1.727-.275-2.332-.405-.558-1.073-.874-1.88-.894l-8.935-.121a.187.187 0 01-.165-.107.197.197 0 01.018-.196c.085-.127.236-.206.395-.206l9.012.122c1.068.046 2.216-.71 2.614-1.672l.511-1.338a.229.229 0 00.014-.122A6.576 6.576 0 008.604 6.4a4.8 4.8 0 00-8.355 3.306c0 .16.009.318.024.474A3.41 3.41 0 000 13.343C0 15.349 1.619 17 3.588 17l12.644-.004c.178 0 .34-.1.42-.256a.467.467 0 00-.044-.565z"/></svg><span className="text-sm font-semibold text-slate-700">Cloudflare</span></span>,
              <span key="hubspot-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#FF7A59"><path d="M22.13 11.384a4.54 4.54 0 00-2.016-1.42V7.575a1.91 1.91 0 001.104-1.725 1.916 1.916 0 00-1.917-1.916 1.916 1.916 0 00-1.916 1.916c0 .78.467 1.452 1.14 1.748v2.36a4.558 4.558 0 00-2.208 1.155l-6.42-4.994a2.133 2.133 0 00.079-.545 2.135 2.135 0 00-2.135-2.135 2.135 2.135 0 00-2.135 2.135 2.135 2.135 0 002.135 2.135c.39 0 .754-.106 1.066-.29l6.3 4.9a4.548 4.548 0 00-.63 2.308c0 .88.25 1.7.686 2.394l-1.917 1.917a1.564 1.564 0 00-.47-.078 1.58 1.58 0 00-1.58 1.581 1.58 1.58 0 001.58 1.58 1.58 1.58 0 001.58-1.58c0-.178-.033-.347-.085-.506l1.886-1.886a4.542 4.542 0 002.867 1.02 4.558 4.558 0 004.558-4.558c0-1.55-.772-2.92-1.95-3.747zm-2.608 6.217a2.469 2.469 0 01-2.469-2.47 2.469 2.469 0 012.469-2.468 2.469 2.469 0 012.469 2.469 2.469 2.469 0 01-2.47 2.469z"/></svg><span className="text-sm font-semibold text-slate-700">HubSpot</span></span>,
              <span key="yell-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 48 20" className="h-5 w-auto flex-shrink-0" aria-hidden="true"><rect width="48" height="20" rx="4" fill="#FFD400"/><text x="24" y="15" textAnchor="middle" fontFamily="Arial Black, Arial, sans-serif" fontWeight="900" fontSize="13" fill="#222">yell</text></svg><span className="text-sm font-semibold text-slate-700">Yell.com</span></span>,
              <span key="elementor-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 40 40" className="h-7 w-7 flex-shrink-0" aria-hidden="true"><rect width="40" height="40" rx="8" fill="#92003B"/><rect x="10" y="10" width="5" height="20" rx="1" fill="#fff"/><rect x="18" y="10" width="12" height="5" rx="1" fill="#fff"/><rect x="18" y="17.5" width="12" height="5" rx="1" fill="#fff"/><rect x="18" y="25" width="12" height="5" rx="1" fill="#fff"/></svg><span className="text-sm font-semibold text-slate-700">Elementor</span></span>,
              <span key="square-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true" fill="#000000"><path d="M19.394 0H4.606C2.062 0 0 2.062 0 4.606v14.788C0 21.938 2.062 24 4.606 24h14.788C21.938 24 24 21.938 24 19.394V4.606C24 2.062 21.938 0 19.394 0zM16.08 16.08c0 1.104-.896 2-2 2H9.92c-1.104 0-2-.896-2-2V9.92c0-1.104.896-2 2-2h4.16c1.104 0 2 .896 2 2v6.16z"/></svg><span className="text-sm font-semibold text-slate-700">Square</span></span>,
              <span key="gcloud-b" className="flex items-center gap-2.5 mx-10 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-300"><svg viewBox="0 0 24 24" className="h-7 w-7 flex-shrink-0" aria-hidden="true"><path d="M12.19 2.38a9.344 9.344 0 00-9.234 6.893c.053-.02-.055.013 0 0-3.875 2.551-3.922 8.11.247 10.62l.05.030a6.548 6.548 0 003.281.875H19.2a5.862 5.862 0 003.814-1.404 5.741 5.741 0 00.88-7.967l-.037-.048-.049-.055a5.698 5.698 0 00-2.37-1.638 9.344 9.344 0 00-9.248-7.306z" fill="#4285F4"/></svg><span className="text-sm font-semibold text-slate-700">Google Cloud</span></span>,
            ].flatMap((logo, i) => [logo, <span key={`sep-b-${i}`} className="text-slate-200 text-xl mx-10 flex-shrink-0" aria-hidden="true">·</span>])}
