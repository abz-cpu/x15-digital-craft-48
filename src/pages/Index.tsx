    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/30">
        <div className="max-w-7xl mx-auto text-center fade-in-section">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
            We offer professional web development & AI automation for UK and global
            businesses. Choose one service or both — transparent pricing, no
            surprises.
            <br />
            <br />
            Websites from £100. AI Automation from £50/month. Enterprise solutions
            ...
            <Card className="hover-lift">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  invoices. What you see is what you pay.
                </p>
              </CardContent>
            </Card>
            ...
            <table className="w-full bg-white rounded-lg shadow-md">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="p-4 text-left font-semibold bg-primary/10">
                    X15 Digital
                  </th>
                </tr>
              </thead>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="hover-lift">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  <strong>Perfect for:</strong> Shops, multi-service businesses,
                  agencies
                </p>
                <Button asChild className="w-full">
                  <Link to="/contact">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-muted">
        <div className="max-w-7xl mx-auto fade-in-section">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="hover-lift relative">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  <strong>Perfect For:</strong> Salons, clinics, offices with high
                  call volume
                </p>
                <Button asChild className="w-full">
                  <Link to="/contact">
          ...
          <div className="text-center mt-12">
            <p className="text-muted-foreground mb-4">
              7+ AI Services Available: Sales Agents, Email Outreach, Social Media,
            ...
            {[
              {
                ...
                description:
                  "Fill out a 2-minute form or WhatsApp us. We reply within 4 hours (usually faster).",
              },
              {
                step: "2",
                title: "We Send You a Clear Quote",
                description:
                  'Exact price, timeline, what\'s included. No "it depends" or sales calls.',
              },
              {
                step: "3",
                title: "We Build It",
                description:
                  "You get progress updates. Unlimited revisions until you're happy.",
              },
              {
                step: "4",
                title: "You Own Everything",
                description:
                  "All code, all files, all access. No monthly fees (unless you want AI automation).",
              },
            ].map((item) => (
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-muted">
        <div className="max-w-7xl mx-auto fade-in-section">
          ...
          <p className="text-center text-muted-foreground mb-12">
            Every website and AI system we build follows industry best practices for
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card>
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground">
                  Hosted on enterprise-grade infrastructure with automatic backups
                  and monitoring.
                </p>
              </CardContent>
            </Card>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm">
                      Salon website + booking system (£450)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-sm">
                      Trade business site with quote forms (£300)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-sm">
                      E-commerce site for local retail (£1,100)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span className="text-sm">
                      AI chatbot for property management (£350 setup)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
