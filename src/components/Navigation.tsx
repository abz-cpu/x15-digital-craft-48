      ...
      >
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 h-full">
          ...
          <div className="flex items-center h-full">
            ...
            >
              {/* L&D Monogram Icon - Clean, modern design */}
              <svg
              ...
              >
                ...
                {/* Rounded container */}
                <rect x="8" y="8" width="84" height="84" rx="18" fill="url(#brandGradient)" />

                {/* L letter */}
                <path
                  d="M25 28 L25 65 L25 68 Q25 72 29 72 L48 72 Q50 72 50 70 Q50 68 48 68 L30 68 Q28 68 28 66 L28 28 Q28 26 25 26 Q25 26 25 28 Z"
                  fill="white"
                />

                {/* Ampersand - smaller and cleaner */}
                <circle cx="50" cy="50" r="2.5" fill="white" opacity="0.6" />

                {/* D letter */}
                <path
                  d="M55 28 Q55 26 58 26 L68 26 Q77 26 77 35 L77 60 Q77 68 68 68 L58 68 Q55 68 55 65 L55 28 Z M60 30 L60 64 L68 64 Q73 64 73 60 L73 35 Q73 30 68 30 L60 30 Z"
                  fill="white"
                />

                {/* Subtle light beam effect */}
                <path d="M15 15 L30 15 L35 25 L20 25 Z" fill="white" opacity="0.2" />
              </svg>
