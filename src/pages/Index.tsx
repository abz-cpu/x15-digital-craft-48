  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section aria-label="Platforms and tools we work with" className="bg-white border-y border-slate-100 py-8">
        ...
        <div className="overflow-hidden relative marquee-wrapper">
          {/* Left fade */}
          <div className="pointer-events-none absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-white to-transparent z-10" />
          {/* Right fade */}
          <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-white to-transparent z-10" />

          {/* Two-track marquee: track 1 slides off left, track 2 fills in, seamless loop */}
          <div className="flex w-full">
          <div className="flex items-center animate-marquee" aria-hidden="false">
