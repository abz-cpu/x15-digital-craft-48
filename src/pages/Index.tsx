      ...
      transition: "transform 0.1s ease-out"
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-10 xl:gap-14">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6">
            ...
            <p className="text-sm sm:text-base text-white/80 max-w-xl mx-auto lg:mx-0">Built for UK businesses. Delivered in 1–14 days. Client-Hosted & Managed. Optional support from £25/month.<span className="font-semibold">1–14 days</span>. No monthly
            ...
            <div className="pt-4">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-stretch gap-4 sm:gap-4 justify-center lg:justify-start max-w-xl mx-auto lg:mx-0">
                ...
                <Link to="/web-package" aria-label="Explore website packages and pricing" className="hero-choice-card hero-choice-card-primary flex-1 lg:flex-[1.2] min-h-[64px] cursor-pointer rounded-xl border border-white/20 bg-white/10 px-4 py-3 flex items-center gap-3 text-left
             focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/80 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent">
                ...
                <Link to="/ai-package" aria-label="Automate my sales with AI" className="hero-choice-card flex-1 lg:flex-[0.9] min-h-[64px] cursor-pointer rounded-xl border border-white/20 bg-white/10 px-4 py-3 flex items-center gap-3 text-left
