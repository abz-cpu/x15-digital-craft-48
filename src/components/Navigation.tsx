...
const Navigation = () => {
  ...
  // Determine if navbar should use light (white text) or dark (dark text) styling
  // Light styling: Homepage when not scrolled
  // Dark styling: All other pages, or homepage when scrolled
  const useLightStyling = isHomePage && !isScrolled;
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-[72px]">
            ...
            >
              <span className={`text-[22px] font-bold tracking-tight transition-colors ${useLightStyling ? "text-white" : "text-white"}`}>X15 DIGITAL</span>
            </PreloadLink>
            ...
            <div className="hidden lg:flex items-center gap-1.5">
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-1.5 text-[15px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg px-3.5 py-2 ${useLightStyling ? "text-white/90 hover:text-white focus:text-white focus:ring-white" : "text-white/90 hover:text-white focus:text-white focus:ring-white"}`}
                  onMouseEnter={() => {
                    clearCloseTimeout();
              ...
              {navLinks.map((link) => (
                <PreloadLink
                  key={link.path}
                  to={link.path}
                  className={`text-[15px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg px-3.5 py-2 text-white/90 hover:text-white focus:text-white focus:ring-white ${location.pathname === link.path ? "text-white font-semibold" : ""}`}
                >
                  {link.name}
                </PreloadLink>
              ))}
              ...
              <a
                ...
                className="flex items-center gap-2 text-[15px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg px-3.5 py-2 ml-1 text-white/90 hover:text-white focus:ring-white"
            ...
            {/* Mobile Menu Button */}
            <button
              className={`lg:hidden p-2 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${useLightStyling ? "hover:bg-white/10 focus:ring-white" : "hover:bg-white/10 focus:ring-white"}`}
