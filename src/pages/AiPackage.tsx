...
const highlightedServices: HighlightedService[] = [{
  ...
  icon: TrendingUp,
  bullets: ["B2B consultants spending 15+ hours/week on manual outreach", "Agencies losing £10k+ deals because follow-ups fall through", "Sales teams sitting on 100+ leads with no system to chase them"],
  ...
  icon: Mail,
  bullets: ["Founders who hate writing cold emails but still need pipeline", "Agencies wanting consistent outbound without hiring a SDR", "Teams whose campaigns die after week one of follow-ups"],
  ...
  icon: Share2,
  bullets: ["Business owners posting once a month (if they remember)", "Solo founders juggling 4+ socials manually", "Local shops and gyms losing customers to competitors who post daily"],
  ...
  icon: Briefcase,
  bullets: ["Owners spending evenings catching up on invoices and forms", "Ops teams copying data between apps all day", "Businesses delaying growth projects because admin eats the week"],
              ...
              <AnimatedSection staggerIndex={1} animation="fade">
                <Card className="hover-lift h-full">
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <h3 className="text-2xl font-bold mb-2">AI Email Assistant</h3>
